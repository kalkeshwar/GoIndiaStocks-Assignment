...
export const LeftArrowIcon = ({className, ...rest}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
  ...
  >
    <path
      fill="currentColor"
      d="M42.168 43.563c1.148 0 1.992-.82 1.992-2.11 0-1.078-.562-1.687-1.547-2.156L17.371 28.07v-.258L42.613 16.68c.985-.469 1.547-1.078 1.547-2.156 0-1.243-.867-2.086-2.086-2.086-.61 0-1.031.164-1.5.398L14.23 24.953c-1.359.61-2.39 1.688-2.39 3.164 0 1.5 1.055 2.531 2.39 3.164l26.344 11.836c.492.235.938.446 1.594.446"
    />
  </svg>
);
